        ...
        <div className='about'>
            ...
            <div className='about3'>
                ...
                <div className='about3_2'>
                    <div className='about3_3'>
                        <img className='abt_img' src={image3} alt='about image' />
                        <img className='abt_img hgt' src={image3} alt='about image' />
                    </div>
                    <img className='abt_img1' src={image3} alt='about image' />
                </div>
            </div>
            <div className='about4'>
                <div className='about4_1'>
                    <h3>Our Team</h3>
                ...
                <img className='about4_2' src={image3} alt='about image' />
            </div>
        </div>
    )
}
